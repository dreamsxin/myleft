...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\db\driver\postgres A phpbb\db\driver\postgres instance.
     */
    protected function getDbal_Conn_DriverService()
    {
        $this->services['dbal.conn.driver'] = $instance = new \phpbb\db\driver\postgres();

        $instance->sql_connect('localhost', 'postgres', 'postgres', 'myleftstudio', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.driver.class' => 'phpbb\\db\\driver\\postgres',
            'dbal.dbhost' => 'localhost',
            'dbal.dbuser' => 'postgres',
            'dbal.dbpasswd' => 'postgres',
            'dbal.dbname' => 'myleftstudio',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
